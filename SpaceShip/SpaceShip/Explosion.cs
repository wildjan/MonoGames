...
namespace SpaceShip
{
    ...
    public class Explosion
    {
        ...
        public void Draw(SpriteBatch spriteBatch)
        {
            if (playing)
            {
                spriteBatch.Draw(tile, drawRectangle, sourceRectangle, Color.White);
            }
        }
        ...
        private void Initialize(Texture2D spriteStrip)
        {
            ...
            frameWidth = tile.Width / Constants.EXPLOSION_FRAMES_PER_ROW;
            frameHeight = tile.Height / GameConstants.EXPLOSION_NUM_ROWS;
